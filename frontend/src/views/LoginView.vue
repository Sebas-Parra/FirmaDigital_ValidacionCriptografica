        ...
        <form @submit.prevent="handleSubmit" class="flex flex-col gap-4">
          ...
          <div v-if="mode === 'register'" class="flex flex-col gap-1.5">
            ...
            <div class="relative">
              ...
              <input id="login-username" v-model="form.username" type="text" placeholder="nombre de usuario" required
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <div class="relative">
              ...
              <input id="login-email" v-model="form.email" type="email" placeholder="tu@email.com" required
                class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"/>
            </div>
          </div>
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <div class="relative">
              ...
              <input id="login-password" v-model="form.password" :type="showPassword ? 'text' : 'password'" placeholder="••••••••" required
